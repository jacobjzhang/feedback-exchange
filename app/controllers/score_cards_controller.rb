class ScoreCardsController < ApplicationController
  ...
  private
    ...
    def score_card_params
      params.require(:score_card).permit(:idea_rating, :idea, :desing_rating, :design, :experience_rating, :experience, :usability_rating, :usability, :monetization_rating, :monetization, :suggestions, :submitted_at, :user_id, :project_id)
    end
end
